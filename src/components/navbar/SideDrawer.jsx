                ...
                <DrawerContent>
                    ...
                    <DrawerBody>
                        <VStack gap={'30px'} mt={'40px'} onClick={onClose}>
                            ...
                            <DrawerCategory handlePath={handlePath} name={'allProducts'} text={"Todos os Produtos"} link={'/allProducts'} />
                            <DrawerCategory handlePath={handlePath} name={'men'} text={"Masculino"} link={'/men'} />
                            <DrawerCategory handlePath={handlePath} name={'women'} text={"Feminino"} link={'women'} />
                            <DrawerCategory handlePath={handlePath} name={'kids'} text={"Infantil"} link={'/kids'} />
                        </VStack>
                    </DrawerBody>
                </DrawerContent>
            </Drawer>
